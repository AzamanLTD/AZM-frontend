...
class _AiOperationsScreenState extends ConsumerState<AiOperationsScreen> {
  ...
  Widget _buildCfoSection(AzamanColors colors) {
    return Column(
      ...
      children: [
        _sectionHeader('AI CFO INSIGHTS', Icons.account_balance, colors),
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(Icons.update, color: colors.warning, size: 18),
          ),
  ...
  Widget _emptyCandidates(AzamanColors colors) {
    return Container(
      ...
      child: Column(
        children: [
          Icon(Icons.celebration, color: colors.success.withOpacity(0.4), size: 40),
          const SizedBox(height: 12),
          Text(
