    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            Container(
              ...
              child: Icon(Icons.visibility, color: colors.danger, size: 18),
            ),
        ...
        actions: [
          if (_isSpying)
            IconButton(
              icon: Icon(Icons.close_fullscreen, color: colors.danger),
              tooltip: "Disconnect",
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Icon(Icons.visibility, color: colors.danger, size: 52),
          ),
