...
class _UsersDashboardState extends ConsumerState<UsersDashboard> {
        ...
        title: Row(
          children: [
            Container(
              ...
              child: Icon(Icons.people, color: colors.success, size: 18),
            ),
  ...
  Widget _buildBody(AzamanColors colors) {
    ...
    return ListView(
      ...
      children: [
        ...
        const SizedBox(height: 24),
        _buildSectionHeader('TOP USERS', Icons.emoji_events, colors),
  ...
  Widget _buildStatsRow(AzamanColors colors) {
    return Row(
      children: [
        Expanded(child: _statCard('Total Users', _formatNum(_totalUsers), Icons.people, colors.success, colors)),
        const SizedBox(width: 10),
        Expanded(child: _statCard('Vendors', _formatNum(_activeVendors), Icons.storefront, colors.accent, colors)),
        const SizedBox(width: 10),
        Expanded(child: _statCard('Pending KYC', _formatNum(_pendingKyc), Icons.hourglass_top, colors.warning, colors)),
      ],
    );
  }
