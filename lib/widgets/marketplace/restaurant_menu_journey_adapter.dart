...
/// Normalizes restaurant catalog data before it reaches the native menu.
///
/// The public menu endpoint can legitimately return products that have not
/// been assigned to a CatalogSection yet. They are not promoted to a fake
